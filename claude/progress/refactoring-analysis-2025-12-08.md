...
Playwright MCPを使用して各ビューの通信量を計測。

### 計測結果（最適化後）

| ビュー | HTML | リソース | **合計** |
|--------|-----:|--------:|--------:|
| ダッシュボード | 49 KB | 138 KB | **187 KB** |
| 公演一覧 | 37 KB | 55 KB | **93 KB** |
| スケジュール | 71 KB | 458 KB | **529 KB** |
| 在庫表示 | 41 KB | 83 KB | **124 KB** |
| 修理管理 | 70 KB | 55 KB | **125 KB** |
| 倉庫間移動 | 59 KB | 135 KB | **193 KB** |
| **機材マスタ** | 290 KB | 63 KB | **353 KB** |
| ユーザーマスタ | 79 KB | 55 KB | **134 KB** |
| **使用場所マスタ** | 79 KB | 55 KB | **135 KB** |
| アクティビティログ | 56 KB | 55 KB | **112 KB** |

### 実施した最適化

**機材マスタ**: ページネーション 200件→50件に変更
- HTML: 680KB → 290KB（57%削減）
- 変更: `EquipmentController.php:66`

**使用場所マスタ**: ページネーション導入（50件/ページ）
- HTML: 216KB → 79KB（63%削減）
- 変更: `LocationController.php:32-36`, `locations/index.blade.php`
- `sort_mode=all`パラメータでソート時は全件表示

### 保留・見送り

| ビュー | 理由 |
|--------|------|
| スケジュール | 一覧性優先のため現状維持（458KB） |
