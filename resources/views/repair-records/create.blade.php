...
@section('header')
    <div class="w-full">
        <h1 class="text-xl sm:text-3xl font-bold text-gray-900 mb-2">修理報告</h1>
                ...
                <div class="bg-white border border-gray-200 rounded-lg">
                    ...
                    <div class="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                        ...
                        <div id="future-reservations-warning" class="hidden">
                            <div class="bg-amber-50 border border-amber-200 rounded-md p-3 sm:p-4">
                                <div class="flex">
                                    ...
                                    <div class="ml-2 sm:ml-3">
                                        ...
                                        <div class="mt-1 sm:mt-2 text-xs sm:text-sm text-amber-700">
                    ...
                    <div class="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                        ...
                        <div>
                            ...
                            @error('photos.*')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                            <p class="mt-1 text-xs text-gray-500">最大2枚までの写真をアップロードできます（最大10MB/枚）</p>
                        ...
                        <div>
                            ...
                            <textarea name="problem_description" id="problem_description" rows="8" required
                                      ...
                                      class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('problem_description') border-red-300 @enderror">{{ old('problem_description') }}</textarea>
                ...
                <div class="bg-white border border-gray-200 rounded-lg">
                    ...
                    <div class="px-4 sm:px-6 py-3 sm:py-4">
                        <textarea name="note" id="note" rows="8"
                                  ...
                                  class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('note') border-red-300 @enderror">{{ old('note') }}</textarea>
                        @error('note')
                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
