...
@section('header')
    <div>
        <h1 class="text-3xl font-bold text-gray-900">ユーザーマスタ作成</h1>
        <p class="mt-1 text-sm text-gray-600">新しいユーザー（担当者）を作成します。</p>
    </div>
        ...
        <div class="max-w-2xl">
            ...
            <div class="mb-6 bg-blue-50 border border-blue-200 rounded-md p-4">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <h3 class="text-sm font-medium text-blue-800">担当者情報の登録について</h3>
                        <div class="mt-2 text-sm text-blue-700">
                            <ul class="list-disc list-inside space-y-1">
                                <li>このユーザーはシステムにログインできません</li>
                                <li>担当者情報として管理のみ行います</li>
                                <li>LINE WORKS認証とは別の管理用ユーザーです</li>
                            </ul>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" name="department" id="department" value="{{ old('department') }}"
                                       class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500
                                              @error('department') border-red-300 @enderror">
                                @error('department')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="position" id="position" value="{{ old('position') }}"
                                       class="w-full border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500
                                              @error('position') border-red-300 @enderror">
                                @error('position')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                            </div>
