...
@section('header')
    <div class="w-full">
        <h1 class="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">新規ユーザー</h1>
                                ...
                                <div class="flex-shrink-0">
                                    <div id="icon-preview-container" class="relative">
                                        <div id="icon-placeholder" class="w-12 h-12 sm:w-16 sm:h-16 bg-gray-300 dark:bg-gray-600 rounded-full flex items-center justify-center">
                                            <span class="text-gray-600 dark:text-gray-300 text-base sm:text-xl">?</span>
                                        </div>
