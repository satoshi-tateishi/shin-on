    ...
    <div class="p-3 sm:p-6">
        <form id="edit-form" method="POST" action="{{ route('master.equipments.update', $equipment) }}" class="max-w-2xl" autocomplete="off"
            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-base sm:text-lg font-medium text-gray-900 dark:text-white">管理設定</h3>
                    </div>
                    <div class="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <!-- スケジュール表示フラグ -->
                            <div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <label for="is_schedule_visible" class="ml-2 block text-xs sm:text-sm text-gray-900 dark:text-white">
                                        スケジュール表に表示する
                                    </label>
                                </div>
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    <input type="checkbox" name="is_discard" id="is_discard" value="1"
                                           x-model="isDiscard"
                                           class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 dark:border-gray-600 dark:bg-gray-700 rounded">
                                    <label for="is_discard" class="ml-2 block text-xs sm:text-sm text-gray-900 dark:text-white">
                                        廃棄
                                    </label>
                                </div>
                                @error('is_discard')
                            ...
                            <!-- 廃棄日 -->
                            <div>
                                <label for="discard_at" class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                    廃棄日
                                </label>
