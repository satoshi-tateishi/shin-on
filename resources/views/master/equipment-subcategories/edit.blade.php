...
@section('header')
    <div class="w-full">
        <h1 class="text-xl sm:text-3xl font-bold text-gray-900 mb-2">{{ $equipmentSubcategory->name }} - 編集</h1>
                ...
                <div class="bg-white border border-gray-200 rounded-lg">
                    ...
                    <div class="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <!-- カテゴリ -->
                            <div>
                                <label for="category_id" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
