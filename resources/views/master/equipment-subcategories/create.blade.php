...
@section('header')
    <div>
        <h1 class="text-3xl font-bold text-gray-900">機材サブカテゴリ作成</h1>
    </div>
...
@section('content')
    <div class="p-6">
        <form method="POST" action="{{ route('master.equipment-subcategories.store') }}" class="max-w-2xl">
            @csrf
