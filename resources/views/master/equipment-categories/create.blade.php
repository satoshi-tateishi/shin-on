...
@section('header')
    <div>
        <h1 class="text-3xl font-bold text-gray-900">機材カテゴリ作成</h1>
        <p class="mt-1 text-sm text-gray-600">新しい機材カテゴリを作成します。</p>
    </div>
...
@section('content')
    <div class="p-6">
        <form method="POST" action="{{ route('master.equipment-categories.store') }}" class="max-w-2xl">
            @csrf
