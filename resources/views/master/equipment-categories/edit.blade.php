...
@section('header')
    <div class="w-full">
        <h1 class="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">{{ $equipmentCategory->name }} - 編集</h1>
        <div class="flex items-center justify-between">
            <a href="{{ route('master.equipment-categories.show', $equipmentCategory) }}"
...
@section('content')
    <div class="p-3 sm:p-6">
        <form id="edit-form" method="POST" action="{{ route('master.equipment-categories.update', $equipmentCategory) }}" class="max-w-2xl">
            @csrf
            @method('PUT')
                    ...
                    <div class="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="name" id="name" value="{{ old('name', $equipmentCategory->name) }}" required
                            ...
                            <div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <input type="checkbox" name="is_active" id="is_active" value="1"
                                           {{ old('is_active', $equipmentCategory->is_active) ? 'checked' : '' }}
