...
@section('header')
    <div class="w-full">
        <h1 class="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">{{ $equipmentSet->name }} - 編集</h1>
...
@section('content')
    <div class="p-3 sm:p-6">
        <form id="edit-form" method="POST" action="{{ route('master.equipment-sets.update', $equipmentSet) }}" class="max-w-2xl">
            @csrf
            @method('PUT')
