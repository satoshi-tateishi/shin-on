...
@section('header')
    <div class="w-full">
        <h1 class="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white mb-2">新規セット</h1>
...
@section('content')
    <div class="p-3 sm:p-6">
        <form id="create-form" method="POST" action="{{ route('master.equipment-sets.store') }}" class="max-w-2xl">
            @csrf
            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
                    ...
                    <div class="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                        ...
                        <!-- 説明 -->
                        <div>
                            <label for="description" class="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                説明
                            </label>
