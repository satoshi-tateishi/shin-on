...
@section('header')
    <div>
        <h1 class="text-3xl font-bold text-gray-900">ポジションマスタ作成</h1>
        <p class="mt-1 text-sm text-gray-600">新しいポジションを作成します。</p>
    </div>
...
@section('content')
    <div class="p-6">
        <form method="POST" action="{{ route('master.positions.store') }}" class="max-w-2xl">
            @csrf
