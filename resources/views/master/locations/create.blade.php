...
@section('content')
    <div class="p-3 sm:p-6">
        <form id="create-form" method="POST" action="{{ route('master.locations.store') }}" class="max-w-2xl">
            @csrf
            ...
            <div class="space-y-4 sm:space-y-6">
                ...
                <div class="bg-white border border-gray-200 rounded-lg">
                    ...
                    <div class="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
                            <!-- タイプ -->
                            <div>
                                <label for="type" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                        ...
                        <div class="bg-blue-50 p-3 sm:p-4 rounded-lg">
                            <h4 class="text-xs sm:text-sm font-medium text-blue-900 mb-2 sm:mb-3">フィルタ表示設定</h4>
                                ...
                                <div>
                                    <div class="flex items-center">
                                        <input type="checkbox" name="is_inventory_visible" id="is_inventory_visible" value="1"
                                               ...
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                        <label for="is_inventory_visible" class="ml-2 block text-xs sm:text-sm text-gray-900">
                                            在庫管理フィルタに表示
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div>
                                    <div class="flex items-center">
                                        <input type="checkbox" name="is_transfer_visible" id="is_transfer_visible" value="1"
                                               ...
                                               class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded">
                                        <label for="is_transfer_visible" class="ml-2 block text-xs sm:text-sm text-gray-900">
                                            倉庫間移動フィルタに表示
                                        </label>
                                    </div>
                                </div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg">
                    ...
                    <div class="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                        ...
                        <div class="grid grid-cols-3 gap-2 sm:gap-4">
                            <div>
                                <label for="tel1_name" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                                    電話1名称
                                </label>
                            ...
                            <div class="col-span-2">
                                <label for="tel1" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                                    電話番号1
                                </label>
                        ...
                        <div class="grid grid-cols-3 gap-2 sm:gap-4">
                            <div>
                                <label for="tel2_name" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                                    電話2名称
                                </label>
                            ...
                            <div class="col-span-2">
                                <label for="tel2" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                                    電話番号2
                                </label>
                        ...
                        <!-- FAX -->
                        <div>
                            <label for="fax" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                                FAX
                            </label>
                        ...
                        <div class="grid grid-cols-3 gap-2 sm:gap-4">
                            <div>
                                <label for="email1_name" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                                    メール1名称
                                </label>
                            ...
                            <div class="col-span-2">
                                <label for="email1" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                                    メール1
                                </label>
                        ...
                        <div class="grid grid-cols-3 gap-2 sm:gap-4">
                            <div>
                                <label for="email2_name" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                                    メール2名称
                                </label>
                            ...
                            <div class="col-span-2">
                                <label for="email2" class="block text-xs sm:text-sm font-medium text-gray-700 mb-1">
                                    メール2
                                </label>
                ...
                <div class="bg-white border border-gray-200 rounded-lg">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                        <h3 class="text-base sm:text-lg font-medium text-gray-900">住所情報</h3>
                    </div>
                    <div class="px-4 sm:px-6 py-3 sm:py-4 space-y-4 sm:space-y-6">
                        <!-- 郵便番号 -->
                        <div>
