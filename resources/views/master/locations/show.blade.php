    ...
    <div class="p-6">
        <div class="max-w-6xl">
            ...
            @if($location->equipments->count() > 0)
                <div class="mt-6 bg-white border border-gray-200 rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900">関連機材 ({{ $location->equipments->count() }}件)</h3>
                    </div>
                    <div class="px-6 py-4">
                                    ...
                                    @foreach($location->equipments as $equipment)
                                        <tr class="hover:bg-gray-50">
                                            <td class="px-4 py-3 whitespace-nowrap">
                                                ...
                                                @if($equipment->model)
                                                    <div class="text-xs text-gray-500">{{ $equipment->model }}</div>
                                                @endif
                                            </td>
            ...
            <div class="mt-6 bg-blue-50 border border-blue-200 rounded-lg">
                ...
                <div class="px-6 py-4">
                    <div class="text-sm text-blue-700">
                        ...
                        <p class="font-medium text-lg text-blue-900">{{ $location->display_name }}</p>
                    </div>
                </div>
            </div>
        </div>
