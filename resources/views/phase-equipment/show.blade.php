...
@section('breadcrumb')
    ...
    > <span class="text-gray-800">機材使用詳細</span>
@endsection

@section('header')
    <div>
        <h1 class="text-3xl font-bold text-gray-900">機材使用詳細</h1>
...
<div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
            ...
            <div class="px-4 py-5 sm:p-6">
                ...
                <div class="mt-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ $phaseEquipment->created_at->format('Y/m/d H:i') }}</dd>
                    </div>
                    ...
                    @if($phaseEquipment->checked_in_at)
                        <div>
                            <dt class="text-sm font-medium text-gray-500">返却担当者</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $phaseEquipment->checkedInBy->name ?? '-' }}</dd>
                        </div>
                        <div>
                            <dt class="text-sm font-medium text-gray-500">返却日時</dt>
                            <dd class="mt-1 text-sm text-gray-900">{{ $phaseEquipment->checked_in_at->format('Y/m/d H:i') }}</dd>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                ...
                @if($phaseEquipment->equipment->description)
                    <div class="mt-4">
                        <dt class="text-sm font-medium text-gray-500">機材説明</dt>
                        <dd class="mt-1 text-sm text-gray-900">{{ $phaseEquipment->equipment->description }}</dd>
                    </div>
                @endif
            </div>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">フェーズ情報</h3>
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
        ...
        @if($phaseEquipment->note)
            ...
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    ...
                    <p class="text-sm text-gray-900 whitespace-pre-line">{{ $phaseEquipment->note }}</p>
                </div>
            </div>
        @endif
    </div>
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-4 py-5 sm:p-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">移動履歴</h3>
                <div class="space-y-3">
                    ...
                    @empty
                        <p class="text-sm text-gray-500 text-center py-4">移動履歴がありません</p>
                    @endforelse
                </div>
            </div>
        </div>
