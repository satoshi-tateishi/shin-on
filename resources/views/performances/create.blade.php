...
@section('header')
    <div class="w-full">
        <h1 class="text-xl sm:text-3xl font-bold text-gray-900 mb-2">新規公演作成</h1>
...
<div class="p-3 sm:p-6">
    <form id="create-form" method="POST" action="{{ route('performances.store') }}" enctype="multipart/form-data" class="space-y-4 sm:space-y-6">
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-md p-3 sm:p-4">
                            <div class="flex">
                                ...
                                <div class="ml-2 sm:ml-3">
                                    <h3 class="text-xs sm:text-sm font-medium text-blue-800">公演期間・会場について</h3>
                                    <p class="mt-1 text-xs sm:text-sm text-blue-700">公演期間と会場は、この後作成するフェーズで詳細に設定します。</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="bg-white border border-gray-200 rounded-lg">
            <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200">
                <h3 class="text-base sm:text-lg font-medium text-gray-900">公演チラシ画像</h3>
            </div>
            <div class="px-4 sm:px-6 py-3 sm:py-4">
        ...
        <div class="bg-white border border-gray-200 rounded-lg">
            ...
            <div class="px-4 sm:px-6 py-3 sm:py-4">
                <textarea name="note" id="note" rows="8"
                          class="w-full text-sm border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 @error('note') border-red-300 @enderror">{{ old('note') }}</textarea>
                @error('note')
                    <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                @enderror
            </div>
