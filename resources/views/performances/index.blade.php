                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gray-50">
                        <tr>
                            ...
                            <th class="px-3 sm:px-6 py-2 sm:py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">種別</th>
                            ...
                            <tr class="hover:bg-gray-50 active:bg-gray-100 cursor-pointer" onclick="window.location='{{ route('performances.show', $performance) }}'">
                                ...
                                <td class="px-3 sm:px-6 py-3 sm:py-4">
                                    <div class="flex flex-col items-start gap-1">
                                        ...
                                        <span class="text-xs text-gray-500">{{ $performance->phases_count ?? 0 }}フェーズ</span>
                                    </div>
                                </td>
                            </tr>
                        @empty
